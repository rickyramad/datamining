            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Informasi Karyawan</h4> </div>
                        <ol class="breadcrumb">
                        </ol>
                    </div>
                    <!-- /.col-lg-12 -->
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="white-box">
                            <h3 class="box-title">Chief Marketing Officer</h3>
                             <input type="button" value="Tahun 2015" onclick="window.location = 'karyawan.php';"/>
                             <input type="button" value="Tahun 2016" onclick="window.location = 'karyawan1.php';"/>
                             <input type="button" value="Tahun 2017" onclick="window.location = 'karyawan2.php';"/>
                                ...
                                <?php
                                       $host='localhost'; 
                                        ...
                                        $karyawan       = mysqli_query($konek, "SELECT DISTINCT d.nama_CMO FROM fakta_penjualan f,dim_cmo d where d.ID_CMO=f.ID_CMO and f.tahun='2015' ORDER BY f.jumlah desc");
                                        $penghasilan = mysqli_query($konek, "SELECT SUM(f.jumlah) FROM fakta_penjualan f, dim_cmo d where d.ID_CMO=f.ID_CMO and f.tahun='2015' GROUP BY d.ID_CMO ORDER BY f.jumlah desc");
                                ?>
                                ...
                                <div class="container">
                                            ...
                                            <script>
                                                ...
                                                var myChart = new Chart(ctx, {
                                                    type: 'bar',
                                                    data: {
                                                        labels: [<?php while ($d = mysqli_fetch_array($karyawan)) { echo '"' . $d['nama_CMO'] .  '",';}?>],     
                                                        datasets: [{
                                                                label: 'Tahun 2015',
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            ...
                            <br>
                            <h3 class="box-title">Data CMO (Chief Marketing Officer) 2015-2017
                            </h3>
                                ...
                                <table class="table ">
                                    ...
                                    <tbody>
                                        <?php
                                                ...
                                                $tampil = "SELECT d.kode_CMO, d.nama_CMO, h.nama_vendor, j.merk_mobil,f.tanggal, f.jumlah, f.angsuran_bulan, f.total_angsuran, f.biaya_administrasi from dim_mobil j, fakta_penjualan f, dim_cmo d, dim_vendor h where j.IDmobil=f.IDmobil and h.IDvendor=f.IDvendor and d.ID_CMO=f.ID_CMO ";
                                            ...
                                            echo "
                                             ...
                                             <td class='txt-oflo'>".$data['kode_CMO']."</td>
                                             <td class='txt-oflo'>".$data['nama_CMO']."</td>
