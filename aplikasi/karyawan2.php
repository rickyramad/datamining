                             ...
                             <input type="button" value="Tahun 2017" onclick="window.location = 'karyawan2.php';"/>
                                ...
                                <?php
                                       $host='localhost'; 
                                        ...
                                        $karyawan       = mysqli_query($konek, "SELECT DISTINCT d.nama_CMO FROM fakta_penjualan f,dim_cmo d where d.ID_CMO=f.ID_CMO and f.tahun='2017'  ORDER BY f.jumlah asc ");
                                        $penghasilan = mysqli_query($konek, "SELECT SUM(f.jumlah) FROM fakta_penjualan f, dim_cmo d where d.ID_CMO=f.ID_CMO and f.tahun='2017' GROUP BY d.ID_CMO ORDER BY f.jumlah asc");
                                ?>
