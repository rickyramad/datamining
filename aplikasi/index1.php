                            ...
                            <input type="button" value="Tahun 2017" onclick="window.location = 'index2.php';"/>
                                ...
                                <?php
                                       $host='localhost'; 
                                        ...
                                        $mobil       = mysqli_query($konek, "SELECT DISTINCT d.merk_mobil FROM fakta_penjualan f,dim_mobil d where d.IDmobil=f.IDmobil and f.tahun='2016'  ORDER BY f.jumlah asc  " );
                                        $penghasilan = mysqli_query($konek, "SELECT SUM(f.jumlah) FROM fakta_penjualan f, dim_mobil d where d.IDmobil=f.IDmobil  and f.tahun='2016' GROUP BY f.IDmobil ORDER BY f.jumlah asc");
                                ?>
