        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="white-box">
                            <h3 class="box-title">Kendaraan yang terjual</h3>
                             <input type="button" value="Tahun 2015" onclick="window.location = 'index.php';"/>
                            <input type="button" value="Tahun 2016" onclick="window.location = 'index1.php';"/>
                            <input type="button" value="Tahun 2017" onclick="window.location = 'index2.php';"/>
                                ...
                                <?php
                                       $host='localhost'; 
                                        ...
                                        mysqli_select_db($konek, $database); 
                                         $mobil       = mysqli_query($konek, "SELECT DISTINCT d.merk_mobil FROM fakta_penjualan f,dim_mobil d where d.IDmobil=f.IDmobil and f.tahun='2017'  ORDER BY f.jumlah asc  " );
                                        $penghasilan = mysqli_query($konek, "SELECT SUM(f.jumlah) FROM fakta_penjualan f, dim_mobil d where d.IDmobil=f.IDmobil  and f.tahun='2017' GROUP BY f.IDmobil ORDER BY f.jumlah asc  ");
                                ?>
                                ...
                                <div class="container">
                                            ...
                                            <script>
                                                ...
                                                var myChart = new Chart(ctx, {
                                                    type: 'bar',
                                                    data: {
                                                        labels: [<?php while ($d = mysqli_fetch_array($mobil)) { echo '"' . $d['merk_mobil'] .  '",';}?>],     
                                                        datasets: [{
                                                                label: 'Tahun 2017',
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            ...
                            <br>
                            <h3 class="box-title">Data Kendaraan 2015-2017
                            </h3>
                                ...
                                <table class="table ">
                                    ...
                                    <tbody>
                                        <?php
                                                ...
                                                $tampil = "SELECT d.IDmobil, d.merk_mobil, d.produk, f.tanggal, f.jumlah, f.angsuran_bulan, f.total_angsuran from dim_mobil d, fakta_penjualan f where d.IDmobil=f.IDmobil ";
                                            ...
                                            echo "
                                             ...
                                             <td class='txt-oflo'>".$data['IDmobil']."</td>
