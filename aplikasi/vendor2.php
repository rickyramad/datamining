                                ...
                                <?php
                                       $host='localhost'; 
                                        ...
                                        mysqli_select_db($konek, $database); 
                                         $vendor       = mysqli_query($konek, "SELECT DISTINCT d.nama_vendor FROM fakta_penjualan f,dim_vendor d where d.IDvendor=f.IDvendor and f.tahun='2017'  ORDER BY f.jumlah asc ");
                                        $penghasilan = mysqli_query($konek, "SELECT SUM(f.jumlah) FROM fakta_penjualan f, dim_vendor d where d.IDvendor=f.IDvendor and f.tahun='2017' GROUP BY d.IDvendor ORDER BY f.jumlah asc");
                                ?>
